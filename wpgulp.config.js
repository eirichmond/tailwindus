...
module.exports = {
	...
	// Project options.
	projectURL: 'https://tailwindus.test', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'tailwind_us', // Your textdomain here.
	translationFile: 'tailwind_us.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'tailwind_us', // Package name.
